...
# Database path - pointing to test.db in the ROOT directory
...
def list_users():
    ...
    # Based on website model.py, the table is "users"
    table_name = "users"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="API Key Management Tool (for test.db)")
